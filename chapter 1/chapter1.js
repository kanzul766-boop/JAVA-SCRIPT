...
document.write("Hello! I can run JS through my web browser's console.");

//write a script to display following message on your web page:(Hint:)
alert("Welcome to JS Land \n Happy Coding!");

//write a script to display following messages in sequence:
alert("Welcome to JS Land...  \n   Happy Coding! Prevent this page from creating additional dialogs.")
...
function showAlert() {
    alert("Hello! Ye ek simple alert hai.");
}
